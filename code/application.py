...
def main():
	...
	while(running_program == True):
		...
		if(user_input == "exit"):
			...
			print("Query 5: Returns a list of information for all events, including event location, average temp on day of event, wind speed, precipitation, visibility, and name of station data was taken at")
			...
			print("Query 5: This query returns a list of information for all events, including event location, average temp on day of event, wind speed, precipitation, visibility, and name of station data was taken at")
